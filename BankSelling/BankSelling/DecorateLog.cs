...
{
    public class DecorateLog : IComponent
    {
  
        private ApplicationContext db;
        private IComponent component;
        public DecorateLog(ApplicationContext _db, IComponent component)
        {
            db = _db;
        ...
        {
            string res = component.CreditInfo(lender);
            db.Logs.Add(new Log { LenderId = lender.Id, Percent = res, Time = DateTime.Now});
            db.SaveChanges();
            return res;
